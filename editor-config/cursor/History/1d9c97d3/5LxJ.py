...
class TestBalanceExceedNotificationMessage:
    def test_construct_balance_exceed_message_with_valid_balance(self):
        ...
        expected_message = "Your balance just passed the $2500.00 alert you set"
                        #    "Your balance just passed the $2500.00 alert you set. Manage your account with confidence - tap to review."
        assert result == expected_message
